...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-d14feba/LibXMTPSwiftFFI.zip",
            checksum: "b03969b875817abdc334d9722a116ad3e7026c9e7ec0c9b0274adff91dc8f9a6"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-d14feba/LibXMTPSwiftFFIDynamic.zip",
                checksum: "354c10a03a4a9936a1280a1697ddd7a02117570d7a12b79581524616c1f29f73"
            ),
        at: 1
    )
}
