...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-8fcbbde/LibXMTPSwiftFFI.zip",
            checksum: "154661113f8922423b13b8647d32ff27348c11c00f7fadebf07b2969ca7a3a4f"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-8fcbbde/LibXMTPSwiftFFIDynamic.zip",
                checksum: "528222f94731256afa41255a17169214e99111c5cdd09d9e1ab57d9a7076e54c"
            ),
        at: 1
    )
}
