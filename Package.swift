    ...
    targets: [
        useLocalBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFI",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-148132e/LibXMTPSwiftFFI.zip",
                checksum: "11dc4deef2f045938e275b6ab9ea5b9ef7f0aa5281711fc34082887d2760df78"
            ),
        useLocalBinary
            ? .binaryTarget(
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-148132e/LibXMTPSwiftFFIDynamic.zip",
                checksum: "bc76b259275516208d890d3307fd4467f2ac106c2dd3cbb68246938aac3cc7bb"
            ),
        .target(
            name: "XMTPiOS",
            dependencies: [
