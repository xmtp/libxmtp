...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0994c7b/LibXMTPSwiftFFI.zip",
            checksum: "c960161e24773ea2fc64ecff46dff03503463982d9de7fc2def77669a557b686"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0994c7b/LibXMTPSwiftFFIDynamic.zip",
                checksum: "b2fd991cc4e2b34b3742158571ef63f57f0e1a45ddafec39eed71aa887170f2d"
            ),
        at: 1
    )
}
