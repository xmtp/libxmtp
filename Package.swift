...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-e7423ca/LibXMTPSwiftFFI.zip",
            checksum: "227410545d2ab24a4343c0ebdb3f8fd15ad2c9e984803dcebb5bbe491098c2be"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-e7423ca/LibXMTPSwiftFFIDynamic.zip",
                checksum: "afa71bd950a4d790e5e1557bdade7d6ef35a5d07d97a31c365b60c9ecf31b62b"
            ),
        at: 1
    )
}
