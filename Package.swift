...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6943ad2/LibXMTPSwiftFFI.zip",
            checksum: "3f6cc4574474f890edfe34766a359dbf868db2136438435cc9e4e3920a4da693"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6943ad2/LibXMTPSwiftFFIDynamic.zip",
                checksum: "6d8035b5928beeb45d534af4cfbd4b7b1f1aab0dfcd07237a269f594133b944c"
            ),
        at: 1
    )
}
