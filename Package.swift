...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6451ef9/LibXMTPSwiftFFI.zip",
            checksum: "216180565888b72a97e094e74fdc872839061f90c85c9300676a17c93187ded4"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6451ef9/LibXMTPSwiftFFIDynamic.zip",
                checksum: "a97f1d1fc176956f300d68636db7ed23f07f32e39a301e5a6f0d68588273f9ed"
            ),
        at: 1
    )
}
