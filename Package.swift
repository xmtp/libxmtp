...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-5b6bcf3/LibXMTPSwiftFFI.zip",
            checksum: "4ed90dd69ff3ebd5a03d5374c2d529ed69079ecaaaa720e133a989660170cb73"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-5b6bcf3/LibXMTPSwiftFFIDynamic.zip",
                checksum: "1e9a48fe9158f4c90cdcc3ffe34a832f8c9ead96efb64a9da365bc600c0a4fed"
            ),
        at: 1
    )
}
