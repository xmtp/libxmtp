...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-33a6d12/LibXMTPSwiftFFI.zip",
            checksum: "4e79bc006647c9d1863e6606d6fe8c03a187061e75eb081ab82964296908e5fa"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-33a6d12/LibXMTPSwiftFFIDynamic.zip",
                checksum: "3e8b58102e69fdd10317fa580f543f307111003fafa681fdb490d0668f3e236b"
            ),
        at: 1
    )
}
