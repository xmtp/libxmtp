...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-2fe143d/LibXMTPSwiftFFI.zip",
            checksum: "a1a5125c10e31b76cd7f3f33b137318f6acd5789ad0735b9b793cbb1b1ceeff2"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-2fe143d/LibXMTPSwiftFFIDynamic.zip",
                checksum: "d7aa36f35b51786e82e54d7a1197a164835abdb99f4ed3654ad65e06445d1329"
            ),
        at: 1
    )
}
