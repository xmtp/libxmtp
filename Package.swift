...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-e13e58d/LibXMTPSwiftFFI.zip",
            checksum: "41a06aadc62e448f787d11af48a129f729b796490e8d3735ad26996c06773982"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-e13e58d/LibXMTPSwiftFFIDynamic.zip",
                checksum: "907c2b9d6ace7c6926f2b50d4a6291c7fb99c1d648b3fb162cfbf2e7e3d5babb"
            ),
        at: 1
    )
}
