...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-a2bdd0a/LibXMTPSwiftFFI.zip",
            checksum: "1ca99cae5d64db6664b6568c7427afba2ef5feab2236a2d0eec757d7b8f45ba2"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-a2bdd0a/LibXMTPSwiftFFIDynamic.zip",
                checksum: "0adbd922da4e0c1e997d0f227265da228b55ee9b90f208633ff4110594468768"
            ),
        at: 1
    )
}
