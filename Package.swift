...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-b4ff3ed/LibXMTPSwiftFFI.zip",
            checksum: "4d54b82b5687fe2b330688a3d1cab754fa4b47ee09bd95aeba1a54ace2d7192a"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-b4ff3ed/LibXMTPSwiftFFIDynamic.zip",
                checksum: "f43e679bdf0bd7cf41bc2f055373ffa22886e2e44095aba0ef6db7dfd5182825"
            ),
        at: 1
    )
}
