...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-4fb5348/LibXMTPSwiftFFI.zip",
            checksum: "4d71b520e06f0d88c26f1e1e9ffb9cc36b1b86c36a1c35b9e0b796ecab77138c"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-4fb5348/LibXMTPSwiftFFIDynamic.zip",
                checksum: "85562d7b0b40db7027fff4ee504973de3fff262049980dcf97b2937b14a031a3"
            ),
        at: 1
    )
}
