...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-727dd7a/LibXMTPSwiftFFI.zip",
            checksum: "586120292da0865e1cc032377037178889286d301effeb817e8deead4114d7ed"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-727dd7a/LibXMTPSwiftFFIDynamic.zip",
                checksum: "6de5498a0cbd148351642c860182cbc5d79821789904d567bd0d8e9ca454bd47"
            ),
        at: 1
    )
}
