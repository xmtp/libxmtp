...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-24ece26/LibXMTPSwiftFFI.zip",
            checksum: "97f52e89bf7ec4344668e62f012acce3f790c7c7cb8122c00099422a08c5fa31"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-24ece26/LibXMTPSwiftFFIDynamic.zip",
                checksum: "de247b79b4f48eeee8bfd4d996ba4c4ba685a86d897ea14466cae892610bba0c"
            ),
        at: 1
    )
}
