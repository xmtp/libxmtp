...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-4b7b477/LibXMTPSwiftFFI.zip",
            checksum: "074820aba820ee9ea3f9ed68a9ca01c349d7bbb7cff8e2c0ff8c6d297a80ab13"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-4b7b477/LibXMTPSwiftFFIDynamic.zip",
                checksum: "023ad69ad1845bb24f414c807c18909ba2cfe035d5f4a760f53fb798a30d77b6"
            ),
        at: 1
    )
}
