...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-42c6bd1/LibXMTPSwiftFFI.zip",
            checksum: "c897166a5a5cdf7126d74b7502a91295bd15ad2d8bc6ad593baacbbe8907b3ca"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-42c6bd1/LibXMTPSwiftFFIDynamic.zip",
                checksum: "a64353810143da0e9931c8591631839f5bfaee50dad3dc0d05eb010e1e2539a8"
            ),
        at: 1
    )
}
