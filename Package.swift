...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-93a012c/LibXMTPSwiftFFI.zip",
            checksum: "f7822fdc03d7e542d272c6d4433652100a8f1de76c8b2a09738bc6aeba54a608"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-93a012c/LibXMTPSwiftFFIDynamic.zip",
                checksum: "6be3ef6fa5affbcee207c52214f058a5f31c4061780ff852dd3b3a699127618c"
            ),
        at: 1
    )
}
