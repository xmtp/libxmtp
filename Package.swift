...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6a8e969/LibXMTPSwiftFFI.zip",
            checksum: "12e905db7dae2c0c0401dc7288ddda84692ec29fc7ec694661bc8e260589c584"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6a8e969/LibXMTPSwiftFFIDynamic.zip",
                checksum: "5e3d03c1deabd86d4e0bd658aecd2ebb7cf26eb33cb552d3931d1013fedd1028"
            ),
        at: 1
    )
}
