...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-35de1c0/LibXMTPSwiftFFI.zip",
            checksum: "bfe9a53d76b1cb3cd0fe31b9de8d4b49d042882d62bdeffc4a9410626abddae4"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-35de1c0/LibXMTPSwiftFFIDynamic.zip",
                checksum: "a760115fb49233ef0b70e4b60f64eea472953222bb313203c33edb01791bde50"
            ),
        at: 1
    )
}
