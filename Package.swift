...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-b951280/LibXMTPSwiftFFI.zip",
            checksum: "2b4b30ec8c54185a7f2a0b4efe08aa05ea0128f017bb54977de28e906e5671e6"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-b951280/LibXMTPSwiftFFIDynamic.zip",
                checksum: "d707c6444fe77417b4dfa101c25eb76becde2c703fe9076e7dfe5b151dceb702"
            ),
        at: 1
    )
}
