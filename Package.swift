...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-1b0bd43/LibXMTPSwiftFFI.zip",
            checksum: "676516aa96d20d3147ffa5b450f8de60dde8791e87a82d34e9f545539a17daad"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-1b0bd43/LibXMTPSwiftFFIDynamic.zip",
                checksum: "8420f4712de18c4355afd4c013a79b65507e6d3c9f411ba462ee228a1f5f61fa"
            ),
        at: 1
    )
}
