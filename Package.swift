...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-4742763/LibXMTPSwiftFFI.zip",
            checksum: "f2234fc9e816e91b14373d1e21fffbaaebade92b4db384a5945175dcb48f9365"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-4742763/LibXMTPSwiftFFIDynamic.zip",
                checksum: "d240479dbb8b23c3a03a8fc3356208132eabfc421b77a6560abbe58ef1dc5809"
            ),
        at: 1
    )
}
