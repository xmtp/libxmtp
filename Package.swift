...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-89f703e/LibXMTPSwiftFFI.zip",
            checksum: "98970d2f1d39ed365a07e6091c9bccd6cd0300c34a83d8ed7b3b6729afd57adf"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-89f703e/LibXMTPSwiftFFIDynamic.zip",
                checksum: "b9d8d5fb5a1bb3de54b0fcbd9eca2adf74666345a4daf85a8231f7110276e6d2"
            ),
        at: 1
    )
}
