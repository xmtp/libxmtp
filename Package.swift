...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-578abea/LibXMTPSwiftFFI.zip",
            checksum: "591ffa57926a7f70fe334ebbfdb113365171aa2399f2f92d73ecde52760599e3"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-578abea/LibXMTPSwiftFFIDynamic.zip",
                checksum: "721d3ecbe4f3b37a7100c8fda3e5d46b0bde3a5537f7409a044a5e7cc8473e8a"
            ),
        at: 1
    )
}
