...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-3e15f8f/LibXMTPSwiftFFI.zip",
            checksum: "ff1a04638bf6ba9452c11d5e022cb49921e4b7d24fbf7fcf58bbbf97304982ac"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-3e15f8f/LibXMTPSwiftFFIDynamic.zip",
                checksum: "bf7e4e9baf71ee198feb2809e040eb9c4a6db5b1a425bc1d9069ad2b3c744c8b"
            ),
        at: 1
    )
}
