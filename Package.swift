...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-49e4227/LibXMTPSwiftFFI.zip",
            checksum: "e85e21e9626804560e2d6911355fd2bf624e14cc363e274e91e3ecc924d7b3ee"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-49e4227/LibXMTPSwiftFFIDynamic.zip",
                checksum: "633715d79624dfb04f3fc46eda19e03d6692376a974320fb59a5cdd04b7b96f5"
            ),
        at: 1
    )
}
