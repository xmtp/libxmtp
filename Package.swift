...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-cc87802/LibXMTPSwiftFFI.zip",
            checksum: "673a5d7f4ab928d52fe3db418ec67de35a28c45f66812057906f5c9990faf139"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-cc87802/LibXMTPSwiftFFIDynamic.zip",
                checksum: "6cfa61cc1ff44f68b4c231ab68bf6d40e4e2f60fc82f2c7523ddae5421cd1bed"
            ),
        at: 1
    )
}
