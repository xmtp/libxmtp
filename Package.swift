...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-66944e2/LibXMTPSwiftFFI.zip",
            checksum: "e3e1261a3ae85d231a98c0f72165b31254f86853772f6860697dbc9a926506bc"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-66944e2/LibXMTPSwiftFFIDynamic.zip",
                checksum: "b8b7370aea624ecbc5eae32a6db2fe85897906c6f79c19689b28ec9da4b46571"
            ),
        at: 1
    )
}
