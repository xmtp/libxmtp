...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0e45c94/LibXMTPSwiftFFI.zip",
            checksum: "6a4604279d36383ed059efe0cbfa025906028dffdecebe4e673c47ad7fe9915d"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0e45c94/LibXMTPSwiftFFIDynamic.zip",
                checksum: "f97ae89fd4847f087f18abbefc7eff13b93f9ae87d16632f669b3e06dbdb9520"
            ),
        at: 1
    )
}
