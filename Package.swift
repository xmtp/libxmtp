...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-c30ac5f/LibXMTPSwiftFFI.zip",
            checksum: "13bf30cf491c19cf4b26f9fc14882006b4f07e9e9051e0c706df058a1f5f61a8"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-c30ac5f/LibXMTPSwiftFFIDynamic.zip",
                checksum: "96a50688042311d1772d4903daca9b14da66b70adb33215f35be0fe1a14e5e0d"
            ),
        at: 1
    )
}
