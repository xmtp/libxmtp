...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-c8c8aba/LibXMTPSwiftFFI.zip",
            checksum: "a9c84d3b80f37c58c9061e8d32ab2a4df4bfafd2183e472d1a48c595398d5233"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-c8c8aba/LibXMTPSwiftFFIDynamic.zip",
                checksum: "fd5e26ab3e8cbb98e63d164f97720d0c9729b815c8f089aab92675711715706e"
            ),
        at: 1
    )
}
