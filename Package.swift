...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0d30e0e/LibXMTPSwiftFFI.zip",
            checksum: "bc8e9e7be38d48dfed58cbae0c847f0d2a7867877836adeda7e96cb7046c60f7"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0d30e0e/LibXMTPSwiftFFIDynamic.zip",
                checksum: "6fb71f584a2bbc6149286b98af9d4689c68d49df2b66f15c4a1a48c81cb49377"
            ),
        at: 1
    )
}
