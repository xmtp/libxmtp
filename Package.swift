...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-b86545d/LibXMTPSwiftFFI.zip",
            checksum: "7fb1ff61c8a9580231d918dda3486a4183b930e8da160f25bb7db5b2dc9ef648"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-b86545d/LibXMTPSwiftFFIDynamic.zip",
                checksum: "adf99100ab92c4e80cbda877f8922841262654584712444d3b4350fbe8bc7c0e"
            ),
        at: 1
    )
}
