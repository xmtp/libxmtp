...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-ac662b3/LibXMTPSwiftFFI.zip",
            checksum: "404eab3fd85f24273dd8cf76f9d389af9d77e74c552320b562ea9240a420a4d6"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-ac662b3/LibXMTPSwiftFFIDynamic.zip",
                checksum: "9e35274f2b8e308a94593b395804517c4757fef43068791e827904332d1b5e05"
            ),
        at: 1
    )
}
