...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-9f72722/LibXMTPSwiftFFI.zip",
            checksum: "a36e85091f4e71e146ff4457cdf267ebb979140ea46636070704513795a6964c"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-9f72722/LibXMTPSwiftFFIDynamic.zip",
                checksum: "db4b0a404fef47032896dc1478bb08ad4f6d21f918035d14bac2e0be2d4b8637"
            ),
        at: 1
    )
}
