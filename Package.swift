...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-47fd011/LibXMTPSwiftFFI.zip",
            checksum: "9e58624d301df3cd3e5ca50a9b7ec3198ab753ab652ad9e8a32f0f9aca87716d"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-47fd011/LibXMTPSwiftFFIDynamic.zip",
                checksum: "97b59117cc7809e3dda7d67778d9717ca90c0590a820722e1e8d87d80ac77597"
            ),
        at: 1
    )
}
