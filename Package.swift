...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-8de69a7/LibXMTPSwiftFFI.zip",
            checksum: "111f5e6f18f6601c88325169b842cf226701826e0c36d3e237c9951304aaa371"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-8de69a7/LibXMTPSwiftFFIDynamic.zip",
                checksum: "9fde19915b94e152436e885df2963dce2f9220edd896e33de4fa35fc4b210ec9"
            ),
        at: 1
    )
}
