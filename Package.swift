...
let package = Package(
	...
	targets: [
		.binaryTarget(
			...
			url: "https://github.com/xmtp/libxmtp/releases/download/swift-bindings-1.9.0-rc2.4232e87/LibXMTPSwiftFFI.zip",
			checksum: "96a253179cf534336131760d5911f22cac907364cf59c108e0c753f37b24873b"
		),
		.target(
			name: "XMTPiOS",
			dependencies: [
