...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-967a035/LibXMTPSwiftFFI.zip",
            checksum: "5025b5ae387a65b62ebcda88273375275431f4dba777699ca369f94e98927b9f"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-967a035/LibXMTPSwiftFFIDynamic.zip",
                checksum: "166ffa0c08f2768e99fd82be9b55c804aacfef34c1979cc67a7399f44e03ef2a"
            ),
        at: 1
    )
}
