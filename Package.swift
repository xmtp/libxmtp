...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-3d3567e/LibXMTPSwiftFFI.zip",
            checksum: "1f47f27eeb62eb11c73394311d5e6068e3b852933bb30e273d2bf450da3d0dad"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-3d3567e/LibXMTPSwiftFFIDynamic.zip",
                checksum: "c47c5c30ee2fbc71b2a6b083eb0ad35410ed81b639824f2b8ea13edf9465ae79"
            ),
        at: 1
    )
}
