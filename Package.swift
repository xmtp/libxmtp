...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-e444995/LibXMTPSwiftFFI.zip",
            checksum: "fcd24297eafebde1ab319f5293b9594e5999497fa349fa07d05030a09f484371"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-e444995/LibXMTPSwiftFFIDynamic.zip",
                checksum: "4e16f89f51c2cded7b629999a17a17859a46707a3de3473b04ec161dfa087b90"
            ),
        at: 1
    )
}
