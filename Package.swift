...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-9588907/LibXMTPSwiftFFI.zip",
            checksum: "c0365cab04c9fcb85a38d2e48d0161591cb3f91e3049bc0e72243cc48634dd60"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-9588907/LibXMTPSwiftFFIDynamic.zip",
                checksum: "5849007a41fdd272677d18cec9b49216d96b388e47a906c4b27020fc74e616ec"
            ),
        at: 1
    )
}
