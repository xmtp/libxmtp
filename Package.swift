...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6a734f1/LibXMTPSwiftFFI.zip",
            checksum: "169dd6c9d1b14295ad8396961c90ab198941dea0eff07eeebfa9973cc69a1d9f"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-6a734f1/LibXMTPSwiftFFIDynamic.zip",
                checksum: "53fd01ee4ac11867a3485e7e18784f1074cb988ab85885d2b11a7d2cfe1ffb32"
            ),
        at: 1
    )
}
