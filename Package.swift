...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-25f7680/LibXMTPSwiftFFI.zip",
            checksum: "67a610d23c38222e85f2a7dc671d99fd2ec764280e77bd68b7b0ce22a00298f1"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-25f7680/LibXMTPSwiftFFIDynamic.zip",
                checksum: "d7043685b2f7adcd9c7c79b74f97c06dc8b1be388b78a9e518099340135777c6"
            ),
        at: 1
    )
}
