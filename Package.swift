...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-11bbf9f/LibXMTPSwiftFFI.zip",
            checksum: "e377d1b30fed4545eb0553a8e1d51159b2b16fecb5cb0967daf8b38275732066"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                    "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-11bbf9f/LibXMTPSwiftFFIDynamic.zip",
                checksum: "253f47b1b4fa94947b220746c6100c47fd332b98296e53cce2558c15950d8401"
            ),
        at: 1
    )
}
