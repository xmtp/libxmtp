...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-3249eec/LibXMTPSwiftFFI.zip",
            checksum: "d6101917de4175e604e4a3fb5e763bdaa4ac7fd63b0cc174e4a83f30bbb95c7a"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-3249eec/LibXMTPSwiftFFIDynamic.zip",
                checksum: "8297d4b74ae739dc60d273910884bfea50183c155b78248206466a42f06ac682"
            ),
        at: 1
    )
}
