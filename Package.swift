...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0f01ea1/LibXMTPSwiftFFI.zip",
            checksum: "4821fa320aafee15ce629b6e2bcb316a2d5336b9b2b4306752f63ed256f74bac"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-0f01ea1/LibXMTPSwiftFFIDynamic.zip",
                checksum: "4ec0098b9598146e8da18d18ea0f75ebaadb8b241b8b64d2ed85650bf6b7609e"
            ),
        at: 1
    )
}
