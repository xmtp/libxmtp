...
var packageTargets: [Target] = [
    useLocalBinary
        ...
        : .binaryTarget(
            name: "LibXMTPSwiftFFI",
            url:
            "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-de26965/LibXMTPSwiftFFI.zip",
            checksum: "baeeb4ade6808a4babbbbf40693d1e81e859df102a860b7f74ab0e0fecb97dd3"
        ),
    .target(
        name: "XMTPiOS",
        dependencies: [
    ...
    packageTargets.insert(
        useLocalDynamicBinary
            ...
            : .binaryTarget(
                name: "LibXMTPSwiftFFIDynamic",
                url:
                "https://github.com/xmtp/libxmtp/releases/download/libxmtp-ios-de26965/LibXMTPSwiftFFIDynamic.zip",
                checksum: "1eb147e63c1c6005ecb0cbbed705d30a71c6ed1816b57d6d430aa99142dfa794"
            ),
        at: 1
    )
}
