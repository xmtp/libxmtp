...
//
	...
	public class FakeApiClient: ApiClient {
		...
		public func query(request _: XMTP.QueryRequest) async throws -> XMTP.QueryResponse {
			abort() // Not supported on Fake
		}

		public func publish(request _: XMTP.PublishRequest) async throws -> XMTP.PublishResponse {
			abort() // Not supported on Fake
		}
	}
