...
public struct Xmtp_MessageContents_DecodedMessage {
	...
	public var messageVersion: String = .init()

	public var senderAddress: String = .init()
	...
	public var hasRecipientAddress: Bool { return _recipientAddress != nil }
	/// Clears the value of `recipientAddress`. Subsequent reads from it will return its default value.
	public mutating func clearRecipientAddress() { _recipientAddress = nil }
	...
	public var contentBytes: Data = .init()

	public var unknownFields = SwiftProtobuf.UnknownStorage()

	public init() {}

	fileprivate var _recipientAddress: String?
...
extension Xmtp_MessageContents_MessageHeaderV1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	fileprivate class _StorageClass {
		var _sender: Xmtp_MessageContents_PublicKeyBundle?
		var _recipient: Xmtp_MessageContents_PublicKeyBundle?
...
extension Xmtp_MessageContents_MessageV1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try try decoder.decodeSingularBytesField(value: &headerBytes)
	...
	public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !headerBytes.isEmpty {
			try visitor.visitSingularBytesField(value: headerBytes, fieldNumber: 1)
		}
...
extension Xmtp_MessageContents_MessageHeaderV2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try try decoder.decodeSingularStringField(value: &topic)
			default: break
			}
		}
	}
...
extension Xmtp_MessageContents_DecodedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			case 2: try try decoder.decodeSingularStringField(value: &messageVersion)
			case 3: try try decoder.decodeSingularStringField(value: &senderAddress)
			case 4: try try decoder.decodeSingularStringField(value: &_recipientAddress)
			case 5: try try decoder.decodeSingularUInt64Field(value: &sentNs)
			case 6: try try decoder.decodeSingularStringField(value: &contentTopic)
			case 7: try try decoder.decodeSingularMessageField(value: &_conversation)
			case 8: try try decoder.decodeSingularBytesField(value: &contentBytes)
			default: break
			}
		}
	}
	...
	public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !messageVersion.isEmpty {
			try visitor.visitSingularStringField(value: messageVersion, fieldNumber: 2)
		}
		if !senderAddress.isEmpty {
			try visitor.visitSingularStringField(value: senderAddress, fieldNumber: 3)
		}
		try { if let v = self._recipientAddress {
			try visitor.visitSingularStringField(value: v, fieldNumber: 4)
		} }()
		if sentNs != 0 {
			try visitor.visitSingularUInt64Field(value: sentNs, fieldNumber: 5)
		}
		if !contentTopic.isEmpty {
			try visitor.visitSingularStringField(value: contentTopic, fieldNumber: 6)
		}
		try { if let v = self._conversation {
			try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
		} }()
		if !contentBytes.isEmpty {
			try visitor.visitSingularBytesField(value: contentBytes, fieldNumber: 8)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
