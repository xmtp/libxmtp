use crate::configuration::WELCOME_WRAPPER_ENCRYPTION_EXTENSION_ID;
...
impl WrapperAlgorithm {
    pub fn to_mls_ciphersuite(&self) -> Ciphersuite {
        match self {
            ...
            WrapperAlgorithm::XWingMLKEM512 => POST_QUANTUM_CIPHERSUITE,
        }
    }
}
...
impl From<WrapperAlgorithm> for WrapperAlgorithmProto {
    fn from(value: WrapperAlgorithm) -> Self {
        match value {
            ...
            WrapperAlgorithm::XWingMLKEM512 => WrapperAlgorithmProto::XwingMlkem512,
        }
    }
}
...
impl From<i32> for WrapperAlgorithm {
    fn from(value: i32) -> Self {
        match value {
            ...
            2 => WrapperAlgorithm::XWingMLKEM512, // WrapperAlgorithmProto::XwingMlkem512
...
mod tests {
    ...
    fn test_serialization() {
        let algorithm = WrapperAlgorithm::XWingMLKEM512;
