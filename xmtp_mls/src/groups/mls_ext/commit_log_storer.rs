use crate::groups::mls_sync::WrappedGroupMessageProcessingError;
...
impl CommitLogStorer for MlsGroup {
    ...
    fn mark_failed_commit_logged<Db: ConnectionExt>(
        ...
        if commit_epoch.as_u64() <= wrapped_error.last_epoch_number && maybe_recently_welcomed {
            return Ok(());
        }
        ...
        NewLocalCommitLog {
            ...
            last_epoch_authenticator: wrapped_error.last_epoch_authenticator.clone(),
            commit_result: wrapped_error.error.commit_result(),
            applied_epoch_number: wrapped_error.last_epoch_number as i64,
            applied_epoch_authenticator: wrapped_error.last_epoch_authenticator.clone(),
            error_message: Some(format!("{:?}", wrapped_error.error)),
            sender_inbox_id: None,
            sender_installation_id: None,
            commit_type: None,
        }
