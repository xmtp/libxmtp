...
impl DecryptedWelcome {
    ...
    pub(crate) fn from_encrypted_bytes<S: XmtpMlsStorageProvider>(
...
pub(super) fn find_key_package_hash_ref<S: XmtpMlsStorageProvider>(
    provider: &XmtpOpenMlsProvider<S>,
    hpke_public_key: &[u8],
...
pub(super) fn find_private_key<S: XmtpMlsStorageProvider>(
    provider: &XmtpOpenMlsProvider<S>,
