...
pub struct WelcomePointersExtension {
    pub aead_types: Vec<AeadType>,
}

impl WelcomePointersExtension {
    pub fn new(aead_types: Vec<AeadType>) -> Self {
        Self { aead_types }
    }
    pub fn available_types() -> Self {
        Self::new(vec![AeadType::ChaCha20Poly1305])
    }
    pub fn empty() -> Self {
        Self::new(vec![])
    }
...
impl TryFrom<&[u8]> for WelcomePointersExtension {
    ...
    fn try_from(value: &[u8]) -> Result<Self, Self::Error> {
        ...
        let aead_types: Vec<AeadType> = proto
            .aead_types
            .iter()
            .copied()
            .map(|aead_type| {
        ...
        Ok(WelcomePointersExtension { aead_types })
    }
}
...
mod tests {
    ...
    fn test_serialization() {
        ...
        let extension = WelcomePointersExtension::default();
        ...
        assert_eq!(deserialized.aead_types, vec![aead_type]);
    }
}
