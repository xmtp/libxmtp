...
impl RetryableError for GroupExtError {
    fn is_retryable(&self) -> bool {
        match self {
            ...
            Self::SqlKeyStore(s) => retryable!(s),
        }
    }
}
...
pub trait MlsGroupExt {
    ...
    /// Get the mutable permission for a mls group
    fn permissions(&self) -> Result<GroupMutablePermissions, GroupMutablePermissionsError>;
}
