...
pub fn wrap_welcome_symmetric(
    ...
    symmetric_key: &[u8],
    nonces: [&[u8]; 2],
) -> Result<[Vec<u8>; 2], WrapWelcomeError> {
    let data_0 = (*LIBCRUX_CRYPTO_PROVIDER).aead_encrypt(
        aead_type,
        symmetric_key,
        data[0],
        nonces[0],
    ...
    let data_1 = (*LIBCRUX_CRYPTO_PROVIDER).aead_encrypt(
        aead_type,
        symmetric_key,
        data[1],
        nonces[1],
...
pub fn unwrap_welcome_symmetric(
    ...
    symmetric_key: &[u8],
    nonces: [&[u8]; 2],
) -> Result<[Vec<u8>; 2], UnwrapWelcomeError> {
    let data_0 = (*LIBCRUX_CRYPTO_PROVIDER).aead_decrypt(
        aead_type,
        symmetric_key,
        data[0],
        nonces[0],
    ...
    let data_1 = (*LIBCRUX_CRYPTO_PROVIDER).aead_decrypt(
        aead_type,
        symmetric_key,
        data[1],
        nonces[1],
