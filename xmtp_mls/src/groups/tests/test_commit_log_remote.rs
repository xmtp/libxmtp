...
async fn test_consecutive_entries_verification_happy_case() {
    ...
    assert_eq!(bo_download_result[0].conversation_id, bo_dm.group_id);
    assert_eq!(
        bo_download_result[0].num_entries_saved, 1,
    ...
    assert_eq!(alix_download_result[0].conversation_id, alix_dm.group_id);
    assert_eq!(
        alix_download_result[0].num_entries_saved, 2,
