    ...
    Context: XmtpSharedContext,
{
    ...
    pub(crate) async fn query_welcome_messages(
        ...
        let cursor = conn.get_last_cursor_for_originators(installation_id, EntityKind::Welcome, &[Originators::WELCOME_MESSAGES.into()])?;
    ...
    pub(crate) async fn query_group_messages(
        ...
        let cursor = conn.get_last_cursor_for_originators(group_id, EntityKind::Group, &[Originators::MLS_COMMITS.into(), Originators::APPLICATION_MESSAGES.into()])?;
