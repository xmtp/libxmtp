...
use xmtp_api_d14n::{TrackedStatsClient, protocol::CursorStore};
...
impl<ApiClient, S, Db> ClientBuilder<ApiClient, S, Db> {
    ...
    where
        ApiClient:
            XmtpApi + CursorAwareApi<CursorStore = Arc<dyn CursorStore>> + 'static + Send + Sync,
