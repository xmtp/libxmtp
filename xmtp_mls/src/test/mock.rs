...
use crate::{
    MlsGroupGuard, builder::SyncWorkerMode, client::DeviceSync, context::XmtpMlsLocalContext,
    identity::Identity, utils::VersionInfo,
};
...
mock! {
    pub MockMlsGroup {
        fn sync_inner<'a>(&self, guard: &'a mut MlsGroupGuard) -> Result<SyncSummary, SyncSummary>;
    }
}
