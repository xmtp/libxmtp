...
use crate::xmtp::xmtpv4::{
    BatchSubscribeEnvelopesRequest, BatchSubscribeEnvelopesResponse, PublishEnvelopeRequest,
    PublishEnvelopeResponse, QueryEnvelopesRequest, QueryEnvelopesResponse,
};
...
pub trait LocalXmtpReplicationClient {
    type BatchSubscribeStream<'a>: Stream<Item = Result<BatchSubscribeEnvelopesResponse, Error>>
        + Send
        + 'a
    where
        Self: 'a;
