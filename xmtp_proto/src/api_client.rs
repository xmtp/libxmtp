...
use crate::types::{Cursor, GroupMessage};
...
pub trait XmtpMlsStreams {
    ...
    #[cfg(not(target_arch = "wasm32"))]
    type WelcomeMessageStream: Stream<Item = Result<ProtoWelcomeMessage, Self::Error>> + Send;

    #[cfg(target_arch = "wasm32")]
    type WelcomeMessageStream: Stream<Item = Result<ProtoWelcomeMessage, Self::Error>>;
