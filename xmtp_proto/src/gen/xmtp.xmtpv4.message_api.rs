...
pub mod get_newest_envelope_response {
    ...
    pub struct Response {
        #[prost(message, optional, tag = "1")]
        pub originator_envelope:
            ::core::option::Option<super::super::envelopes::OriginatorEnvelope>,
    }
    impl ::prost::Name for Response {
        const NAME: &'static str = "Response";
        const PACKAGE: &'static str = "xmtp.xmtpv4.message_api";
...
pub mod replication_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::QueryEnvelopesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::PublishPayerEnvelopesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::GetInboxIdsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::GetNewestEnvelopeResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
...
pub mod replication_api_server {
    ...
    pub trait ReplicationApi: std::marker::Send + std::marker::Sync + 'static {
        ...
        type SubscribeEnvelopesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::SubscribeEnvelopesResponse, tonic::Status>,
            > + std::marker::Send
            + 'static;
        async fn subscribe_envelopes(
            &self,
            request: tonic::Request<super::SubscribeEnvelopesRequest>,
        ) -> std::result::Result<tonic::Response<Self::SubscribeEnvelopesStream>, tonic::Status>;
            ...
            match req.uri().path() {
                "/xmtp.xmtpv4.message_api.ReplicationApi/SubscribeEnvelopes" => {
                    ...
                    impl<T: ReplicationApi>
                        tonic::server::ServerStreamingService<super::SubscribeEnvelopesRequest>
                        for SubscribeEnvelopesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ReplicationApi>::subscribe_envelopes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.ReplicationApi/QueryEnvelopes" => {
                        ...
                        for QueryEnvelopesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ReplicationApi>::query_envelopes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.ReplicationApi/PublishPayerEnvelopes" => {
                        ...
                        for PublishPayerEnvelopesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ReplicationApi>::publish_payer_envelopes(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/xmtp.xmtpv4.message_api.ReplicationApi/GetInboxIds" => {
                    ...
                    impl<T: ReplicationApi> tonic::server::UnaryService<super::GetInboxIdsRequest>
                ...
                "/xmtp.xmtpv4.message_api.ReplicationApi/GetNewestEnvelope" => {
                        ...
                        for GetNewestEnvelopeSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ReplicationApi>::get_newest_envelope(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xmtp.xmtpv4.message_api.MisbehaviorApi/SubmitMisbehaviorReport" => {
                        ...
                        for SubmitMisbehaviorReportSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MisbehaviorApi>::submit_misbehavior_report(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/xmtp.xmtpv4.message_api.MisbehaviorApi/QueryMisbehaviorReports" => {
                        ...
                        for QueryMisbehaviorReportsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MisbehaviorApi>::query_misbehavior_reports(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
