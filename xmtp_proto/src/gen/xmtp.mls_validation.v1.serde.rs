...
impl serde::Serialize for VerifySmartContractWalletSignaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesRequest", len)?;
        if !self.signatures.is_empty() {
...
impl<'de> serde::Deserialize<'de> for VerifySmartContractWalletSignaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesRequest")
            }
        ...
        deserializer.deserialize_struct("xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VerifySmartContractWalletSignaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesResponse", len)?;
        if !self.responses.is_empty() {
            struct_ser.serialize_field("responses", &self.responses)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for VerifySmartContractWalletSignaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesResponse")
            }
        ...
        deserializer.deserialize_struct("xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for verify_smart_contract_wallet_signatures_response::ValidationResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesResponse.ValidationResponse", len)?;
        if self.is_ok {
            struct_ser.serialize_field("isOk", &self.is_ok)?;
        }
        if !self.error_message.is_empty() {
...
impl<'de> serde::Deserialize<'de> for verify_smart_contract_wallet_signatures_response::ValidationResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesResponse.ValidationResponse")
            }
        ...
        deserializer.deserialize_struct("xmtp.mls_validation.v1.VerifySmartContractWalletSignaturesResponse.ValidationResponse", FIELDS, GeneratedVisitor)
    }
}
