...
impl serde::Serialize for welcome_message::V1 {
        ...
        S: serde::Serializer,
    {
        ...
        if self.group_refresh_state_cursor != 0 {
            len += 1;
        }
        ...
        if self.group_refresh_state_cursor != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("groupRefreshStateCursor", ToString::to_string(&self.group_refresh_state_cursor).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for welcome_message::V1 {
        ...
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "wrapper_algorithm",
            "wrapperAlgorithm",
            "group_refresh_state_cursor",
            "groupRefreshStateCursor",
        ];
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "groupRefreshStateCursor" | "group_refresh_state_cursor" => Ok(GeneratedField::GroupRefreshStateCursor),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut group_refresh_state_cursor__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Id => {
                            if id__.is_some() {
                        ...
                        GeneratedField::GroupRefreshStateCursor => {
                            if group_refresh_state_cursor__.is_some() {
                                return Err(serde::de::Error::duplicate_field("groupRefreshStateCursor"));
                            }
                            group_refresh_state_cursor__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                    }
                ...
                Ok(welcome_message::V1 {
                    ...
                    group_refresh_state_cursor: group_refresh_state_cursor__.unwrap_or_default(),
                })
            }
        }
