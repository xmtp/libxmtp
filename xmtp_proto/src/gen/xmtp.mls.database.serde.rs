...
impl serde::Serialize for UpdatePendingRemoveListsData {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.mls.database.UpdatePendingRemoveListsData", len)?;
        if let Some(v) = self.version.as_ref() {
            match v {
                update_pending_remove_lists_data::Version::V1(v) => {
                    struct_ser.serialize_field("v1", v)?;
                }
            }
        }
...
impl<'de> serde::Deserialize<'de> for UpdatePendingRemoveListsData {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = UpdatePendingRemoveListsData;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls.database.UpdatePendingRemoveListsData")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<UpdatePendingRemoveListsData, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut version__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::V1 => {
                            ...
                            version__ = map_.next_value::<::std::option::Option<_>>()?.map(update_pending_remove_lists_data::Version::V1)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                ...
                Ok(UpdatePendingRemoveListsData {
                    version: version__,
                })
            }
        }
        deserializer.deserialize_struct("xmtp.mls.database.UpdatePendingRemoveListsData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for update_pending_remove_lists_data::V1 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for update_pending_remove_lists_data::V1 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            "pending_remove_list_update_type",
            "pendingRemoveListUpdateType",
            "inbox_id",
            "inboxId",
        ];
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "pendingRemoveListUpdateType" | "pending_remove_list_update_type" => Ok(GeneratedField::PendingRemoveListUpdateType),
                            "inboxId" | "inbox_id" => Ok(GeneratedField::InboxId),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = update_pending_remove_lists_data::V1;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls.database.UpdatePendingRemoveListsData.V1")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<update_pending_remove_lists_data::V1, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut pending_remove_list_update_type__ = None;
                let mut inbox_id__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::PendingRemoveListUpdateType => {
                ...
                Ok(update_pending_remove_lists_data::V1 {
                    pending_remove_list_update_type: pending_remove_list_update_type__.unwrap_or_default(),
                    inbox_id: inbox_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xmtp.mls.database.UpdatePendingRemoveListsData.V1", FIELDS, GeneratedVisitor)
    }
}
