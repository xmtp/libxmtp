...
impl<'de> serde::Deserialize<'de> for UserPreferenceUpdate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls.message_contents.UserPreferenceUpdate")
            }
        ...
        deserializer.deserialize_struct("xmtp.mls.message_contents.UserPreferenceUpdate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WelcomeWrapperAlgorithm {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::XwingMlkem512 => "WELCOME_WRAPPER_ALGORITHM_XWING_MLKEM_512",
        };
        serializer.serialize_str(variant)
    }
}
impl<'de> serde::Deserialize<'de> for WelcomeWrapperAlgorithm {
        ...
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "WELCOME_WRAPPER_ALGORITHM_XWING_MLKEM_512",
        ];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "WELCOME_WRAPPER_ALGORITHM_XWING_MLKEM_512" => Ok(WelcomeWrapperAlgorithm::XwingMlkem512),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
