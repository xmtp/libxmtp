        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "aeadTypes" | "aead_types" => Ok(GeneratedField::AeadTypes),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WelcomePointeeEncryptionAeadTypesExtension, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut aead_types__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::AeadTypes => {
                            if aead_types__.is_some() {
                                return Err(serde::de::Error::duplicate_field("aeadTypes"));
                            }
                            aead_types__ = Some(map_.next_value::<Vec<WelcomePointeeEncryptionAeadType>>()?.into_iter().map(|x| x as i32).collect());
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                        }
                ...
                Ok(WelcomePointeeEncryptionAeadTypesExtension {
                    aead_types: aead_types__.unwrap_or_default(),
                })
            }
        }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::V1 => {
                            ...
                            version__ = map_.next_value::<::std::option::Option<_>>()?.map(welcome_pointer::Version::V1)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
...
impl serde::Serialize for welcome_pointer::V1 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xmtp.mls.message_contents.WelcomePointer.V1", len)?;
        if !self.destination.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for welcome_pointer::V1 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = welcome_pointer::V1;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xmtp.mls.message_contents.WelcomePointer.V1")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<welcome_pointer::V1, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("xmtp.mls.message_contents.WelcomePointer.V1", FIELDS, GeneratedVisitor)
    }
}
