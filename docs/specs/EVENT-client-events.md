...
| `attachment.upload_failed` | A pending attachment's status becomes `failed` (ATCH-025, ATCH-026, ATCH-029, ATCH-036, ATCH-047) | Transition | `attachment_upload_failed` |
