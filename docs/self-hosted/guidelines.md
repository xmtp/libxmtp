...
11. Durable state lives in Postgres. Instance-local stream state and caches are disposable; reconnect must not depend on them. Database helpers use internal types; API layers own wire conversion.
