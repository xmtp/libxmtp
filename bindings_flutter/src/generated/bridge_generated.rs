...
fn wire_Client_is_active_group_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Client_is_active_group",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse(
                    (move || async move {
                        let api_that = api_that.rust_auto_opaque_decode_ref();
                        crate::libxmtp_api::Client::is_active_group(&api_that, api_group_id).await
                    })()
                    .await,
                )
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        10 => wire_Client_add_member_impl(port, ptr, rust_vec_len, data_len),
        ...
        8 => wire_Client_is_active_group_impl(port, ptr, rust_vec_len, data_len),
        6 => wire_Client_list_groups_impl(port, ptr, rust_vec_len, data_len),
        9 => wire_Client_list_members_impl(port, ptr, rust_vec_len, data_len),
        13 => wire_Client_list_messages_impl(port, ptr, rust_vec_len, data_len),
        11 => wire_Client_remove_member_impl(port, ptr, rust_vec_len, data_len),
        12 => wire_Client_send_message_impl(port, ptr, rust_vec_len, data_len),
        14 => wire_SignatureRequiredClient_sign_impl(port, ptr, rust_vec_len, data_len),
