...
function Factory(Module) {
  ...
  sqlite3.bind_int = (function() {
    ...
    return function(stmt, i, value) {
      verifyStatement(stmt);
      if (value > 0x7fffffff || value < -0x80000000) return SQLITE_RANGE;
...
function sqlite3_result_int(context, value) {
  sqlite3.result_int(context, value);
}

function sqlite3_result_int64(context, value) {
  sqlite3.result_int64(context, value);
}

function sqlite3_result_double(context, value) {
  sqlite3.result_double(context, value);
}

function sqlite3_result_blob(context, value) {
  sqlite3.result_blob(context, value);
}
...
function batch_execute(database, query) {
  try {
...
export { batch_execute, establish, sqlite3_result_blob, sqlite3_result_double, sqlite3_result_int, sqlite3_result_int64, sqlite3_result_null, sqlite3_result_text };
