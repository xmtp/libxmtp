...
var sqlite3InitModule = (() => {
  ...
  return function (config) {
    ...
    (Module['_sqlite3__wasm_db_error'] =
      function () {
...
class SQLite {
  ...
  result_js(context, value) {
    this.sqlite3.capi.result_js(context, value);
  }

  result_text(context, value) {
    this.sqlite3.capi.result_text(context, value);
  }

  result_int(context, value) {
    this.sqlite3.capi.result_int(context, value);
  }

  result_int64(context, value) {
    this.sqlite3.capi.result_int64(context, value);
  }

  result_double(context, value) {
    this.sqlite3.capi.result_double(context, value);
  }

  result_blob(context, value) {
    this.sqlite3.capi.result_blob(context, value);
  }

  result_null(context) {
    this.sqlite3.capi.result_null(context);
  }
  ...
  bind_blob(stmt, i, value) {
    try {
      return this.sqlite3.capi.bind_blob(stmt, i, value);
    } catch (error) {
  ...
  bind_collection(stmt, bindings) {
    try {
      return this.sqlite3.capi.bind_collection(stmt, bindings);
    } catch (error) {
  ...
  bind_double(stmt, i, value) {
    try {
      return this.sqlite3.capi.bind_double(stmt, i, value);
    } catch (error) {
  ...
  bind_int(stmt, i, value) {
    try {
      return this.sqlite3.capi.bind_int(stmt, i, value);
    } catch (error) {
  ...
  bind_int64(stmt, i, value) {
    try {
      return this.sqlite3.capi.bind_int64(stmt, i, value);
    } catch (error) {
  ...
  bind_null(stmt, i) {
    try {
      return this.sqlite3.capi.bind_null(stmt, i);
    } catch (error) {
  ...
  bind_parameter_count(stmt) {
    return this.sqlite3.capi.bind_parameter_count(stmt);
  }

  bind_parameter_name(stmt, i) {
    return this.sqlite3.capi.bind_paramater_name(stmt, it);
  }

  bind_text(stmt, i, value) {
    try {
      this.sqlite3.capi.bind_text(stmt, i, value);
    } catch (error) {
  ...
  async reset(stmt) {
    try {
      return await this.sqlite3.capi.reset(stmt);
    } catch (error) {
  ...
  value(pValue) {
    this.sqlite3.capi.value_to_js(pValue);
  }

  value_dup(pValue) {
    return this.sqlite.capi.value_dup(pValue);
  }

  value_blob(pValue) {
    this.sqlite3.capi.value_blob(pValue);
  }

  value_bytes(pValue) {
    this.sqlite3.capi.value_bytes(pValue);
  }

  value_double(pValue) {
    this.sqlite3.capi.value_double(pValue);
  }

  value_int(pValue) {
    this.sqlite3.capi.value_int(pValue);
  }

  value_int64(pValue) {
    this.sqlite3.capi.value_int64(pValue);
  }

  value_text(pValue) {
    this.sqlite3.capi.value_text(pValue);
  }

  value_type(pValue) {
    return this.sqlite3.capi.value_type(pValue);
  }

  async open(database_url, iflags) {
    try {
  ...
  finalize(stmt) {
    try {
      return this.sqlite3.capi.finalize(stmt);
    } catch (error) {
      error("stmt error");
      throw error;
    }
  ...
  changes(db) {
    return this.sqlite3.capi.changes(db);
  }
  ...
  async prepare_v3(db, sql, nByte, prepFlags, ppStmt, pzTail) {
  ...
  column(stmt, i) {
    try {
      return this.sqlite3.column_js(stmt, i);
    } catch (error) {
  ...
  create_function(
    ...
    try {
      this.sqlite3.capi.create_function(
        database,
        functionName,
        nArg,
        textRep,
