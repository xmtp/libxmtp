...
// AmbireTech: https://github.com/AmbireTech/signature-validator/blob/7706bda/index.ts#L13
// Note that this is not a __complete___ ERC-6492 implementation as it lacks Prepare/Side-effect logic compared to reference implementation.
