...
pub mod mock_multi_ownable {
    ...
    impl<M: ::ethers::providers::Middleware> MockMultiOwnable<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                MOCKMULTIOWNABLE_ABI.clone(),
                MOCKMULTIOWNABLE_BYTECODE.clone().into(),
                client,
            );
        ...
        ///Calls the contract's `init` (0x459fb2ad) function
        pub fn init(
            &self,
            owners: ::std::vec::Vec<::ethers::core::types::Bytes>,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([69, 159, 178, 173], owners)
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, MockMultiOwnableEvents>
        {
            self.0
    ...
    pub enum MockMultiOwnableErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for MockMultiOwnableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for MockMultiOwnableErrors {
    ...
    impl ::ethers::contract::ContractRevert for MockMultiOwnableErrors {
    ...
    impl ::core::fmt::Display for MockMultiOwnableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for MockMultiOwnableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AlreadyOwner> for MockMultiOwnableErrors {
        fn from(value: AlreadyOwner) -> Self {
            Self::AlreadyOwner(value)
        }
    }
    impl ::core::convert::From<InvalidEthereumAddressOwner> for MockMultiOwnableErrors {
        fn from(value: InvalidEthereumAddressOwner) -> Self {
            Self::InvalidEthereumAddressOwner(value)
        }
    }
    impl ::core::convert::From<InvalidOwnerBytesLength> for MockMultiOwnableErrors {
        fn from(value: InvalidOwnerBytesLength) -> Self {
            Self::InvalidOwnerBytesLength(value)
        }
    }
    impl ::core::convert::From<NoOwnerAtIndex> for MockMultiOwnableErrors {
        fn from(value: NoOwnerAtIndex) -> Self {
            Self::NoOwnerAtIndex(value)
        }
    }
    impl ::core::convert::From<Unauthorized> for MockMultiOwnableErrors {
    ...
    pub enum MockMultiOwnableEvents {
        AddOwnerFilter(AddOwnerFilter),
        RemoveOwnerFilter(RemoveOwnerFilter),
    }
    impl ::ethers::contract::EthLogDecode for MockMultiOwnableEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AddOwnerFilter::decode_log(log) {
                return Ok(MockMultiOwnableEvents::AddOwnerFilter(decoded));
            }
            if let Ok(decoded) = RemoveOwnerFilter::decode_log(log) {
                return Ok(MockMultiOwnableEvents::RemoveOwnerFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for MockMultiOwnableEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddOwnerFilter> for MockMultiOwnableEvents {
        fn from(value: AddOwnerFilter) -> Self {
            Self::AddOwnerFilter(value)
        }
    }
    impl ::core::convert::From<RemoveOwnerFilter> for MockMultiOwnableEvents {
    ...
    ///Container type for all input parameters for the `init` function with signature `init(bytes[])` and selector `0x459fb2ad`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    pub enum MockMultiOwnableCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for MockMultiOwnableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for MockMultiOwnableCalls {
    ...
    impl ::core::fmt::Display for MockMultiOwnableCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddOwnerAddressCall> for MockMultiOwnableCalls {
        fn from(value: AddOwnerAddressCall) -> Self {
            Self::AddOwnerAddress(value)
        }
    }
    impl ::core::convert::From<AddOwnerPublicKeyCall> for MockMultiOwnableCalls {
        fn from(value: AddOwnerPublicKeyCall) -> Self {
            Self::AddOwnerPublicKey(value)
        }
    }
    impl ::core::convert::From<InitCall> for MockMultiOwnableCalls {
        fn from(value: InitCall) -> Self {
            Self::Init(value)
        }
    }
    impl ::core::convert::From<IsOwnerAddressCall> for MockMultiOwnableCalls {
        fn from(value: IsOwnerAddressCall) -> Self {
            Self::IsOwnerAddress(value)
        }
    }
    impl ::core::convert::From<IsOwnerBytesCall> for MockMultiOwnableCalls {
        fn from(value: IsOwnerBytesCall) -> Self {
            Self::IsOwnerBytes(value)
        }
    }
    impl ::core::convert::From<IsOwnerPublicKeyCall> for MockMultiOwnableCalls {
        fn from(value: IsOwnerPublicKeyCall) -> Self {
            Self::IsOwnerPublicKey(value)
        }
    }
    impl ::core::convert::From<NextOwnerIndexCall> for MockMultiOwnableCalls {
        fn from(value: NextOwnerIndexCall) -> Self {
            Self::NextOwnerIndex(value)
        }
    }
    impl ::core::convert::From<OwnerAtIndexCall> for MockMultiOwnableCalls {
        fn from(value: OwnerAtIndexCall) -> Self {
            Self::OwnerAtIndex(value)
        }
    }
    impl ::core::convert::From<RemoveOwnerAtIndexCall> for MockMultiOwnableCalls {
