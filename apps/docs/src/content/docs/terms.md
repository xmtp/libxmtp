...
description: Documentation licensing terms.
---
...
This means that except as otherwise noted, page content is licensed under the [Creative Commons Attribution 4.0 License](https://creativecommons.org/licenses/by/4.0/) and code samples are licensed under the [MIT License](https://spdx.org/licenses/MIT.html).
...
Again, please link back to the original source page so that readers can refer to it. This is even more important when the content has been modified.
