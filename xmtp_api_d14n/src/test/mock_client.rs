...
use xmtp_proto::types::{Cursor, GroupId, GroupMessage, InstallationId};
...
mod not_wasm {
    ...
    mock! {
        ...
        impl XmtpMlsClient for ApiClient {
            ...
            async fn query_welcome_messages(&self, installation_key: InstallationId, cursor: Vec<Cursor>) -> Result<Vec<xmtp_proto::types::WelcomeMessage>, MockError>;
