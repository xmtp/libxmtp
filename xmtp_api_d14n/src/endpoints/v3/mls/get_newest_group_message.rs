...
impl Endpoint for GetNewestGroupMessage {
    ...
    fn http_endpoint(&self) -> Cow<'static, str> {
        Cow::Borrowed("/mls/v1/get-newest-group-message")
    }

    fn grpc_endpoint(&self) -> Cow<'static, str> {
        crate::path_and_query::<GetNewestGroupMessageRequest>()
    }
...
mod test {
    ...
    fn test_file_descriptor() {
        let pnq = crate::path_and_query::<GetNewestGroupMessageRequest>();
        println!("{}", pnq);
    }
    ...
    async fn test_get_newest_group_message() {
        ...
        let result: GetNewestGroupMessageResponse = endpoint.query(&client).await.unwrap();
        assert_eq!(
    ...
    fn test_get_newest_group_message_endpoints() {
        ...
        assert_eq!(endpoint.http_endpoint(), "/mls/v1/get-newest-group-message");
        assert_eq!(
