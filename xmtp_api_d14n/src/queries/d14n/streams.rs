    ...
    E: std::error::Error + RetryableError + Send + Sync + 'static,
{
    ...
    type GroupMessageStream =
        TryExtractorStream<XmtpStream<<C as Client>::Stream, SubscribeEnvelopesResponse>, GroupMessageExtractor>;

    type WelcomeMessageStream =
        TryExtractorStream<XmtpStream<<C as Client>::Stream, SubscribeEnvelopesResponse>, WelcomeMessageExtractor>;
    ...
    async fn subscribe_group_messages(
        ...
        let _stream = SubscribeEnvelopes::builder()
            ...
            .build()?
            .stream(&self.message_client).await?;
