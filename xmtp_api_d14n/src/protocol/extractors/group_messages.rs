use xmtp_proto::{mls_v1::group_message, types::{Cursor, GroupMessage, GroupMessageBuilder}, ConversionError};

use crate::protocol::Extractor;
use crate::protocol::traits::EnvelopeVisitor;
use openmls::{
    framing::MlsMessageIn,
    prelude::{tls_codec::Deserialize, ContentType, ProtocolMessage},
};
use chrono::DateTime;
...
impl EnvelopeVisitor<'_> for GroupMessageExtractor {
    ...
    fn visit_group_message_v1(&mut self, message: &group_message_input::V1) -> Result<(), Self::Error> {
...
fn extract_common_mls(builder: &mut GroupMessageBuilder, mut data: &[u8]) -> Result<bool, ConversionError> {
