...
describe.concurrent('EnrichedMessage', () => {
  ...
  describe('Basic message retrieval', () => {
    ...
    it('should handle list options', async () => {
      ...
      expect(allTextMessages.length).toBeGreaterThanOrEqual(3)
    })
  })
  ...
  describe('Message metadata', () => {
    it('should include message kind', async () => {
      ...
      await conversation.send(encodeTextMessage('Test'))
      ...
      expect(messagesWithKind.length).toBeGreaterThanOrEqual(1)
    })
  })
  ...
  describe('Content types', () => {
    ...
    contentTypeTestCases.forEach(({ name, content, assertions }) => {
      it(`should handle ${name}`, async () => {
        ...
        await conversation.send(content as EncodedContent)
    ...
    it('should handle reaction content in reactions array', async () => {
      ...
      expect(textMessageWithReaction!.reactions.length).toBeGreaterThanOrEqual(
        1
      )
  ...
  describe('Group operations', () => {
    it('should include group updated messages when members are added', async () => {
      ...
      expect(groupUpdatedMessages.length).toBeGreaterThanOrEqual(1)
