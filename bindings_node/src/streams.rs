...
use xmtp_mls::{client::ClientError, StreamHandle, AbortHandle, StreamHandleError, GenericStreamHandle};
...
impl NapiStreamCloser {
  pub fn new(handle: impl StreamHandle<StreamOutput = Result<(), ClientError>> + Send + Sync + 'static) -> Self {
