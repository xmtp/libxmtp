...
impl<'g> MlsGroupAppData<'g> {
    ...
    ///
    pub fn new(extensions: &'g Extensions<GroupContext>) -> Self {
        Self { extensions }
    }
    ...
    /// (decode) failures.
    pub fn get<C: Component>(&self) -> Result<Option<C::Value>, ComponentSourceError> {
...
// in `xmtp_mls`'s `groups/tests/test_proposals.rs`; constructing an `OpenMlsGroup`
