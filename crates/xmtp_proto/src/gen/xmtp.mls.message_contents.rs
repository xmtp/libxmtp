...
pub struct PlaintextCommitLogEntry {
    ...
    pub installation_hmac: ::prost::alloc::vec::Vec<u8>,
}
...
impl ::prost::Name for ForkAdminChange {
    ...
    const PACKAGE: &'static str = "xmtp.mls.message_contents";
    fn full_name() -> ::prost::alloc::string::String {
        "xmtp.mls.message_contents.ForkAdminChange".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/xmtp.mls.message_contents.ForkAdminChange".into()
    }
