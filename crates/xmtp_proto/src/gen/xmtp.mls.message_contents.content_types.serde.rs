...
impl serde::Serialize for DeleteMessage {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.message_id.is_empty() {
            struct_ser.serialize_field("message_id", &self.message_id)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for EditMessage {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.edited_content.as_ref() {
            struct_ser.serialize_field("edited_content", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for LeaveRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.authenticated_note.as_ref() {
            ...
            struct_ser.serialize_field("authenticated_note", pbjson::private::base64::encode(&v).as_str())?;
        }
        struct_ser.end()
    }
}
