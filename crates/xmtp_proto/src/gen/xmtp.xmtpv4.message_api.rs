        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/xmtp.xmtpv4.message_api.ReplicationApi/SubscribeAllEnvelopes" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeAllEnvelopesSvc<T: ReplicationApi>(pub Arc<T>);
                    impl<
                        T: ReplicationApi,
                    > tonic::server::ServerStreamingService<
                    ...
                    > for SubscribeAllEnvelopesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ReplicationApi>::subscribe_all_envelopes(
                                        &inner,
                                        request,
                                    )
                                    .await
