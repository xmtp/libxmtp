...
just test workspace -p xmtp_cryptography --ignore-default-filter test_public_key_generation_and_address   # one test
just test workspace -p xmtp_cryptography ethereum::   # one module
```
