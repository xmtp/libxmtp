...
- `SCREAMING_SNAKE_CASE` for a free constant. Group related endpoints as an empty struct with associated consts (`common/api.rs:GrpcUrls`, `DockerUrls`), selected by `if_dev!` / `if_local!`.
