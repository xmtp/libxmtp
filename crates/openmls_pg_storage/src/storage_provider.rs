...
use sqlx::{
    Encode, PgExecutor, Postgres, Type, encode::IsNull, error::BoxDynError, postgres::PgTypeInfo,
    query, query_as, query_scalar,
};

use super::{
    EntityRefWrapper, EntitySliceWrapper, KeyRefWrapper, PostgresStorageProvider,
    StorableGroupIdRef,
...
// `Send + Sync` on the codec: its futures must be `Send`, and the codec appears
// (as `PhantomData<C>`) inside the `Storable*Ref` wrappers captured across awaits,
// so `C` has to be `Sync`. Codecs are zero-sized strategy types, so this is free.
impl<C: Codec + Send + Sync> StorageProvider<CURRENT_VERSION> for PostgresStorageProvider<'_, C> {
    ...
    >(
        ...
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::JoinGroupConfig)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable.store::<_, C>(&mut **connection, group_id).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::Tree)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::Context)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::ConfirmationTag)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::GroupState)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::MessageSecrets)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, C>(&mut **connection, group_id, GroupDataType::OwnLeafIndex)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable.store::<_, C>(&mut **connection, public_key).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .store::<_, _, C>(&mut **connection, group_id, epoch, leaf_index)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable.store::<_, C>(&mut **connection, hash_ref).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable.store::<_, C>(&mut **connection, psk_id).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableLeafNode::load::<_, C>(&mut **connection, group_id).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableProposal::<u8, ProposalRef>::load_refs::<_, C>(&mut **connection, group_id).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableProposal::load::<_, C>(&mut **connection, group_id).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableGroupData::load::<_, C>(&mut **connection, group_id, GroupDataType::Tree).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableGroupData::load::<_, C>(&mut **connection, group_id, GroupDataType::Context).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableGroupData::load::<_, C>(&mut **connection, group_id, GroupDataType::GroupState).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableSignatureKeyPairs::load::<_, C>(&mut **connection, public_key).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableEncryptionKeyPair::load::<_, C>(&mut **connection, public_key).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        load_epoch_key_pairs::<_, _, _, C>(&mut **connection, group_id, epoch, leaf_index).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        StorableKeyPackage::load::<_, C>(&mut **connection, hash_ref).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        load_psk_bundle::<_, _, C>(&mut **connection, psk_id).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_proposal(&mut **connection, proposal_ref)
            .await
    }
    ...
    async fn delete_tree<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_group_data(&mut **connection, GroupDataType::Tree)
            .await
    }
    ...
    async fn delete_group_state<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_group_data(&mut **connection, GroupDataType::GroupState)
            .await
    }
    ...
    async fn delete_context<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_group_data(&mut **connection, GroupDataType::Context)
            .await
    }
    ...
    async fn delete_interim_transcript_hash<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_group_data(&mut **connection, GroupDataType::InterimTranscriptHash)
            .await
    }
    ...
    async fn delete_own_leaf_index<GroupId: traits::GroupId<CURRENT_VERSION>>(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_group_data(&mut **connection, GroupDataType::OwnLeafIndex)
            .await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable.delete::<C>(&mut **connection).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_epoch_key_pair(&mut **connection, epoch, leaf_index)
            .await
    }
    ...
    async fn delete_key_package<KeyPackageRef: traits::HashReference<CURRENT_VERSION>>(
        ...
        let mut connection = self.connection.lock().await;
        storable.delete_key_package::<C>(&mut **connection).await
    }
    ...
    >(
        ...
        let mut connection = self.connection.lock().await;
        storable
            .delete_group_data(&mut **connection, GroupDataType::ApplicationExportTree)
            .await
    }
}

// --- Encode/Type glue for the borrow wrappers -------------------------------
//
// Each wrapper serializes its inner value with the codec `C` and binds the
// resulting bytes as a Postgres `BYTEA`.

impl<T: Key<CURRENT_VERSION>, C: Codec> Type<Postgres> for KeyRefWrapper<'_, T, C> {
    fn type_info() -> PgTypeInfo {
        <Vec<u8> as Type<Postgres>>::type_info()
    }
}

impl<'q, T: Key<CURRENT_VERSION>, C: Codec> Encode<'q, Postgres> for KeyRefWrapper<'_, T, C> {
    fn encode_by_ref(
        &self,
        buf: &mut <Postgres as sqlx::Database>::ArgumentBuffer<'q>,
    ) -> Result<IsNull, BoxDynError> {
        let key_bytes = C::to_vec(self.0)?;
        <Vec<u8> as Encode<'q, Postgres>>::encode(key_bytes, buf)
    }
}

impl<T: Entity<CURRENT_VERSION>, C: Codec> Type<Postgres> for EntityRefWrapper<'_, T, C> {
    fn type_info() -> PgTypeInfo {
        <Vec<u8> as Type<Postgres>>::type_info()
    }
}

impl<'q, T: Entity<CURRENT_VERSION>, C: Codec> Encode<'q, Postgres> for EntityRefWrapper<'_, T, C> {
    fn encode_by_ref(
        &self,
        buf: &mut <Postgres as sqlx::Database>::ArgumentBuffer<'q>,
    ) -> Result<IsNull, BoxDynError> {
        let entity_bytes = C::to_vec(self.0)?;
        <Vec<u8> as Encode<'q, Postgres>>::encode(entity_bytes, buf)
    }
}

impl<T: Entity<CURRENT_VERSION>, C: Codec> Type<Postgres> for EntitySliceWrapper<'_, T, C> {
    fn type_info() -> PgTypeInfo {
        <Vec<u8> as Type<Postgres>>::type_info()
    }
}

impl<'q, T: Entity<CURRENT_VERSION>, C: Codec> Encode<'q, Postgres> for EntitySliceWrapper<'_, T, C> {
    fn encode_by_ref(
        &self,
        buf: &mut <Postgres as sqlx::Database>::ArgumentBuffer<'q>,
    ) -> Result<IsNull, BoxDynError> {
...
impl<GroupData: Entity<CURRENT_VERSION>> StorableGroupData<GroupData> {
    async fn load<GroupId: Key<CURRENT_VERSION>, C: Codec>(
        ...
        let group_data: Option<Vec<u8>> = query_scalar(
        ...
        .await?;
        group_data.map(C::from_bytes).transpose()
    }
}
...
impl<LeafNode: Entity<CURRENT_VERSION>> StorableLeafNode<LeafNode> {
    async fn load<GroupId: Key<CURRENT_VERSION>, C: Codec>(
        ...
        let key_ref = KeyRefWrapper::<_, C>::new(group_id);
        let rows: Vec<Vec<u8>> =
            query_scalar("SELECT leaf_node FROM openmls_own_leaf_node WHERE group_id = $1")
                .bind(key_ref)
                .fetch_all(executor)
                .await?;
        rows.into_iter().map(C::from_bytes).collect()
    }
}
    ...
    StorableProposal<Proposal, ProposalRef>
{
    async fn load<GroupId: Key<CURRENT_VERSION>, C: Codec>(
        ...
        let rows: Vec<(Vec<u8>, Vec<u8>)> =
            query_as("SELECT proposal_ref, proposal FROM openmls_proposal WHERE group_id = $1")
                .bind(key_ref)
                .fetch_all(executor)
                .await?;
        rows.into_iter()
            .map(|(proposal_ref, proposal)| {
                let proposal_ref = C::from_bytes(proposal_ref)?;
                let proposal = C::from_bytes(proposal)?;
    ...
    async fn load_refs<GroupId: Key<CURRENT_VERSION>, C: Codec>(
        ...
        let key_ref = KeyRefWrapper::<_, C>::new(group_id);
        let rows: Vec<Vec<u8>> =
            query_scalar("SELECT proposal_ref FROM openmls_proposal WHERE group_id = $1")
                .bind(key_ref)
                .fetch_all(executor)
                .await?;
        rows.into_iter().map(C::from_bytes).collect()
...
impl<SignatureKeyPairs: Entity<CURRENT_VERSION>> StorableSignatureKeyPairs<SignatureKeyPairs> {
    async fn load<SignaturePublicKey: SignaturePublicKeyTrait<CURRENT_VERSION>, C: Codec>(
        ...
        let row: Option<Vec<u8>> =
            query_scalar("SELECT signature_key FROM openmls_signature_key WHERE public_key = $1")
                .bind(key_ref)
                .fetch_optional(executor)
                .await?;
        row.map(C::from_bytes).transpose()
    }
}
...
impl<EncryptionKeyPair: Entity<CURRENT_VERSION>> StorableEncryptionKeyPair<EncryptionKeyPair> {
    async fn load<EncryptionKey: Key<CURRENT_VERSION>, C: Codec>(
        ...
        let row: Option<Vec<u8>> =
            query_scalar("SELECT key_pair FROM openmls_encryption_key WHERE public_key = $1")
                .bind(public_key)
                .fetch_optional(executor)
                .await?;
        row.map(C::from_bytes).transpose()
...
>(
    ...
    let row: Option<Vec<u8>> = query_scalar(
...
impl<KeyPackage: Entity<CURRENT_VERSION>> StorableKeyPackage<KeyPackage> {
    async fn load<KeyPackageRef: Key<CURRENT_VERSION>, C: Codec>(
        ...
        let row: Option<Vec<u8>> =
            query_scalar("SELECT key_package FROM openmls_key_package WHERE key_package_ref = $1")
                .bind(key_package_ref)
                .fetch_optional(executor)
                .await?;
        row.map(C::from_bytes).transpose()
...
>(
    ...
    let row: Option<Vec<u8>> = query_scalar("SELECT psk_bundle FROM openmls_psk WHERE psk_id = $1")
        .bind(psk_id)
        .fetch_optional(executor)
        .await?;
    row.map(C::from_bytes).transpose()
...
impl<GroupId: Key<CURRENT_VERSION>, C: Codec> StorableGroupIdRef<'_, GroupId, C> {
    async fn delete_all_proposals(&self, executor: impl PgExecutor<'_>) -> sqlx::Result<()> {
        let group_id = KeyRefWrapper::<_, C>(self.0, PhantomData);
        query("DELETE FROM openmls_proposal WHERE group_id = $1")
            .bind(group_id)
            .execute(executor)
            .await?;
        Ok(())
    ...
    async fn delete_proposal<ProposalRef: ProposalRefTrait<CURRENT_VERSION>>(
        ...
        query("DELETE FROM openmls_proposal WHERE group_id = $1 AND proposal_ref = $2")
            .bind(group_id)
            .bind(proposal_ref)
            .execute(executor)
            .await?;
    ...
    async fn delete_leaf_nodes(&self, executor: impl PgExecutor<'_>) -> sqlx::Result<()> {
        let group_id = KeyRefWrapper::<_, C>(self.0, PhantomData);
        query("DELETE FROM openmls_own_leaf_node WHERE group_id = $1")
            .bind(group_id)
            .execute(executor)
            .await?;
        Ok(())
    ...
    async fn delete_group_data(
        ...
        let group_id = KeyRefWrapper::<_, C>(self.0, PhantomData);
        query("DELETE FROM openmls_group_data WHERE group_id = $1 AND data_type = $2")
            .bind(group_id)
            .bind(data_type)
            .execute(executor)
            .await?;
...
{
    async fn delete<C: Codec>(&self, executor: impl PgExecutor<'_>) -> sqlx::Result<()> {
        let public_key = KeyRefWrapper::<_, C>(self.0, PhantomData);
        query("DELETE FROM openmls_signature_key WHERE public_key = $1")
            .bind(public_key)
            .execute(executor)
            .await?;
        Ok(())
    ...
    StorableEncryptionPublicKeyRef<'_, EncryptionPublicKey>
{
    async fn delete<C: Codec>(&self, executor: impl PgExecutor<'_>) -> sqlx::Result<()> {
        let public_key = KeyRefWrapper::<_, C>(self.0, PhantomData);
        query("DELETE FROM openmls_encryption_key WHERE public_key = $1")
            .bind(public_key)
            .execute(executor)
            .await?;
        Ok(())
...
impl<KeyPackageRef: Key<CURRENT_VERSION>> StorableHashRef<'_, KeyPackageRef> {
    async fn delete_key_package<C: Codec>(
        ...
        query("DELETE FROM openmls_key_package WHERE key_package_ref = $1")
            .bind(hash_ref)
            .execute(executor)
            .await?;
        Ok(())
...
impl<PskId: Key<CURRENT_VERSION>> StorablePskIdRef<'_, PskId> {
    async fn delete<C: Codec>(&self, executor: impl PgExecutor<'_>) -> sqlx::Result<()> {
        ...
        query("DELETE FROM openmls_psk WHERE psk_id = $1")
            .bind(psks_id)
            .execute(executor)
            .await?;
        Ok(())
