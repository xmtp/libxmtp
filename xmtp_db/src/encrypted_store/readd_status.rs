...
mod tests {
    ...
    fn create_test_readd_status_with_sequences(
        group_id: Vec<u8>,
        inbox_id: String,
        ...
        ReaddStatus {
            ...
            inbox_id,
            installation_id,
            requested_at_sequence_id: requested_at,
            responded_at_sequence_id: responded_at,
        }
    }
    ...
    async fn test_store_and_get_readd_status() {
        with_connection(|conn| {
            ...
            let status = create_test_readd_status_with_sequences(
                group_id.clone(),
                inbox_id.clone(),
    ...
    async fn test_update_requested_at_sequence_id_updates_existing() {
        with_connection(|conn| {
            ...
            let initial_status = create_test_readd_status_with_sequences(
                group_id.clone(),
                inbox_id.clone(),
                installation_id.clone(),
                Some(50),
