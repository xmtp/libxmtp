...
pub struct NewTask {
    ...
    pub initial_backoff_duration_ns: i64,
    pub next_attempt_at_ns: i64,
    // Would skip these if the derive_builder crate had support for skipping fields
    #[builder(setter(skip))]
    pub data_hash: Vec<u8>,
    #[builder(setter(skip))]
    pub data: Vec<u8>,
...
impl NewTaskBuilder {
    pub fn build(&mut self, task: TaskProto) -> Result<NewTask, StorageError> {
        ...
        let new_task = NewTask {
            originating_message_id: self.originating_message_id.flatten(),
            ...
            task: Some(
                xmtp_proto::xmtp::mls::database::task::Task::ProcessWelcomePointer(
                    xmtp_proto::xmtp::mls::message_contents::WelcomePointer {
                        version: Some(xmtp_proto::xmtp::mls::message_contents::welcome_pointer::Version::V1(xmtp_proto::xmtp::mls::message_contents::welcome_pointer::V1 {
                            ...
                            nonces: vec![xmtp_common::rand_vec::<12>(), xmtp_common::rand_vec::<12>()],
                        })),
                    },
                ),
            ),
