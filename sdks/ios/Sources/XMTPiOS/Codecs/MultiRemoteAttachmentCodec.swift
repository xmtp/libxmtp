...
public let ContentTypeMultiRemoteAttachment = ContentTypeID(
...
public struct MultiRemoteAttachmentCodec: ContentCodec {
	...
	public func fallback(content _: MultiRemoteAttachment) throws -> String? {
		"MultiRemoteAttachment not supported"
	}

	public func shouldPush(content _: MultiRemoteAttachment) throws -> Bool {
		true
	}
	...
	static func encryptBytesForLocalAttachment(_ bytesToEncrypt: Data,
	                                           filename: String) throws -> EncryptedEncodedContent
	{
		try RemoteAttachment.encodeEncryptedBytes(encodedContent: bytesToEncrypt, filename: filename)
	}
	...
	static func decryptAttachment(_ encryptedAttachment: EncryptedEncodedContent) throws -> EncodedContent {
		...
		try RemoteAttachment.decryptEncoded(encrypted: encryptedAttachment)
	}
}
