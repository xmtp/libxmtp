...
public struct FfiConverterTypeFfiWorkerConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiWorkerConfig {
        return
            try FfiWorkerConfig(
                ...
                jitterNs: FfiConverterOptionUInt64.read(from: &buf), 
    ...
    public static func write(_ value: FfiWorkerConfig, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionUInt64.write(value.jitterNs, into: &buf)
 ...
 * ```
 */
public func createClient(api: XmtpApiClient, syncApi: XmtpApiClient, db: DbOptions, inboxId: String, accountIdentifier: FfiIdentifier, nonce: UInt64, legacySignedPrivateKeyProto: Data?, deviceSyncMode: FfiDeviceSyncMode?, allowOffline: Bool?, forkRecoveryOpts: FfiForkRecoveryOpts?, workerConfig: FfiWorkerConfig?)async throws  -> FfiXmtpClient  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_xmtpv3_checksum_func_create_client() != 6531) {
        return InitializationResult.apiChecksumMismatch
    }
