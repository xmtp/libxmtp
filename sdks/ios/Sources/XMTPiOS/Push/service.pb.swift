...
public struct Notifications_V1_DeliveryMechanism {
	...
	public enum OneOf_DeliveryMechanismType: Equatable {
		...
		#if !swift(>=4.1)
			public static func == (
				lhs: Notifications_V1_DeliveryMechanism.OneOf_DeliveryMechanismType,
				rhs: Notifications_V1_DeliveryMechanism.OneOf_DeliveryMechanismType
			) -> Bool {
...
public struct Notifications_V1_RegisterInstallationRequest {
	...
	public var hasDeliveryMechanism: Bool { _deliveryMechanism != nil }
	...
	private var _deliveryMechanism: Notifications_V1_DeliveryMechanism?
}
...
extension Notifications_V1_DeliveryMechanism: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
	...
	public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		case .customToken?: try {
				guard case let .customToken(v)? = self.deliveryMechanismType else { preconditionFailure() }
...
extension Notifications_V1_RegisterInstallationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &installationID)
			case 2: try decoder.decodeSingularMessageField(value: &_deliveryMechanism)
			default: break
			}
		}
	}
...
extension Notifications_V1_RegisterInstallationResponse: SwiftProtobuf.Message,
	...
	SwiftProtobuf._ProtoNameProviding
{
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &installationID)
			case 2: try decoder.decodeSingularUInt64Field(value: &validUntil)
			default: break
			}
		}
	}
...
extension Notifications_V1_DeleteInstallationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
...
extension Notifications_V1_Subscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &topic)
			case 2: try decoder.decodeRepeatedMessageField(value: &hmacKeys)
			case 3: try decoder.decodeSingularBoolField(value: &isSilent)
			default: break
			}
		}
	}
	...
	public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !hmacKeys.isEmpty {
			try visitor.visitRepeatedMessageField(value: hmacKeys, fieldNumber: 2)
		}
		if isSilent != false {
			try visitor.visitSingularBoolField(value: isSilent, fieldNumber: 3)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Notifications_V1_Subscription.HmacKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			// enabled. https://github.com/apple/swift-protobuf/issues/1034
			switch fieldNumber {
			case 1: try decoder.decodeSingularUInt32Field(value: &thirtyDayPeriodsSinceEpoch)
...
extension Notifications_V1_SubscribeWithMetadataRequest: SwiftProtobuf.Message,
	SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
	...
	public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
		while let fieldNumber = try decoder.nextFieldNumber() {
			...
			switch fieldNumber {
			case 1: try decoder.decodeSingularStringField(value: &installationID)
			case 2: try decoder.decodeRepeatedMessageField(value: &subscriptions)
			default: break
			}
		}
	}
	...
	public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
		...
		if !subscriptions.isEmpty {
			try visitor.visitRepeatedMessageField(value: subscriptions, fieldNumber: 2)
		}
		try unknownFields.traverse(visitor: &visitor)
	}
...
extension Notifications_V1_SubscribeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
...
extension Notifications_V1_UnsubscribeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
	SwiftProtobuf._ProtoNameProviding
{
