...
public protocol Notifications_V1_NotificationsClientInterface: Sendable {
	...
	@available(iOS 13, *)
	func registerInstallation(request: Notifications_V1_RegisterInstallationRequest, headers: Connect.Headers) async
		-> ResponseMessage<Notifications_V1_RegisterInstallationResponse>
	...
	@available(iOS 13, *)
	func deleteInstallation(request: Notifications_V1_DeleteInstallationRequest, headers: Connect.Headers) async
		-> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
	...
	@available(iOS 13, *)
	func subscribe(request: Notifications_V1_SubscribeRequest, headers: Connect.Headers) async
		-> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
	...
	@available(iOS 13, *)
	func subscribeWithMetadata(request: Notifications_V1_SubscribeWithMetadataRequest, headers: Connect.Headers) async
		-> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
	...
	@available(iOS 13, *)
	func unsubscribe(request: Notifications_V1_UnsubscribeRequest, headers: Connect.Headers) async
		-> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
}
...
public final class Notifications_V1_NotificationsClient: Notifications_V1_NotificationsClientInterface, Sendable {
	...
	@available(iOS 13, *)
	public func deleteInstallation(request: Notifications_V1_DeleteInstallationRequest,
	                               headers: Connect
	                               	.Headers = [:]) async -> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
	{
		await client.unary(
			path: "/notifications.v1.Notifications/DeleteInstallation",
			idempotencyLevel: .unknown,
	...
	@available(iOS 13, *)
	public func subscribe(request: Notifications_V1_SubscribeRequest,
	                      headers: Connect.Headers = [:]) async -> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
	{
		await client.unary(
			path: "/notifications.v1.Notifications/Subscribe",
			idempotencyLevel: .unknown,
	...
	@available(iOS 13, *)
	public func unsubscribe(request: Notifications_V1_UnsubscribeRequest,
	                        headers: Connect.Headers = [:]) async -> ResponseMessage<SwiftProtobuf.Google_Protobuf_Empty>
	{
		await client.unary(
			path: "/notifications.v1.Notifications/Unsubscribe",
