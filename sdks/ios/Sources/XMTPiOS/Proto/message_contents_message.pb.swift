...
public struct Xmtp_MessageContents_MessageHeaderV1: @unchecked Sendable {
...
public struct Xmtp_MessageContents_MessageHeaderV2: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Versioned Message
public struct Xmtp_MessageContents_Message: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
