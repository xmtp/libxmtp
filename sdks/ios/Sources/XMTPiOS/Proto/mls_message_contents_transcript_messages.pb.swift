...
public struct Xmtp_Mls_MessageContents_GroupMembershipChanges: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Xmtp_Mls_MessageContents_GroupUpdated: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var leftInboxes: [Xmtp_Mls_MessageContents_GroupUpdated.Inbox] = []

  /// The inboxes that were added to admin list in the commit
  public var addedAdminInboxes: [Xmtp_Mls_MessageContents_GroupUpdated.Inbox] = []

  /// The inboxes that were removed from admin list in the commit
  public var removedAdminInboxes: [Xmtp_Mls_MessageContents_GroupUpdated.Inbox] = []

  /// The inboxes that were added to super admin list in the commit
  public var addedSuperAdminInboxes: [Xmtp_Mls_MessageContents_GroupUpdated.Inbox] = []

  /// The inboxes that were removed from super admin list in the commit
  public var removedSuperAdminInboxes: [Xmtp_Mls_MessageContents_GroupUpdated.Inbox] = []
...
extension Xmtp_Mls_MessageContents_GroupUpdated: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.leftInboxes) }()
      case 6: try { try decoder.decodeRepeatedMessageField(value: &self.addedAdminInboxes) }()
      case 7: try { try decoder.decodeRepeatedMessageField(value: &self.removedAdminInboxes) }()
      case 8: try { try decoder.decodeRepeatedMessageField(value: &self.addedSuperAdminInboxes) }()
      case 9: try { try decoder.decodeRepeatedMessageField(value: &self.removedSuperAdminInboxes) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.leftInboxes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.leftInboxes, fieldNumber: 5)
    }
    if !self.addedAdminInboxes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.addedAdminInboxes, fieldNumber: 6)
    }
    if !self.removedAdminInboxes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.removedAdminInboxes, fieldNumber: 7)
    }
    if !self.addedSuperAdminInboxes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.addedSuperAdminInboxes, fieldNumber: 8)
    }
    if !self.removedSuperAdminInboxes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.removedSuperAdminInboxes, fieldNumber: 9)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Xmtp_Mls_MessageContents_GroupUpdated, rhs: Xmtp_Mls_MessageContents_GroupUpdated) -> Bool {
    ...
    if lhs.leftInboxes != rhs.leftInboxes {return false}
    if lhs.addedAdminInboxes != rhs.addedAdminInboxes {return false}
    if lhs.removedAdminInboxes != rhs.removedAdminInboxes {return false}
    if lhs.addedSuperAdminInboxes != rhs.addedSuperAdminInboxes {return false}
    if lhs.removedSuperAdminInboxes != rhs.removedSuperAdminInboxes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
