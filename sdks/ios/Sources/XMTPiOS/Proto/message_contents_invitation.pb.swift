...
public enum Xmtp_MessageContents_ConsentProofPayloadVersion: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public struct Xmtp_MessageContents_InvitationV1: Sendable {
  ...
  /// message encryption scheme and keys for this conversation.
  public enum OneOf_Encryption: Equatable, Sendable {
    /// Specify the encryption method to process the key material properly.
...
public struct Xmtp_MessageContents_SealedInvitationHeaderV1: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Xmtp_MessageContents_SealedInvitation: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Xmtp_MessageContents_ConsentProofPayload: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
