...
import org.xmtp.kotlin.libxmtp.ArchiveMetadata
import org.xmtp.kotlin.libxmtp.ArchiveOptions
import org.xmtp.kotlin.libxmtp.AvailableArchive
import org.xmtp.kotlin.libxmtp.IdentityKind
import org.xmtp.kotlin.libxmtp.InboxState
import org.xmtp.kotlin.libxmtp.PublicIdentity
import org.xmtp.kotlin.libxmtp.SignatureRequest
import org.xmtp.kotlin.libxmtp.toFfi
    ...
    companion object {
            ...
            withContext(Dispatchers.IO) {
                ...
                ffiClient.signatureRequest()?.let { signatureRequest ->
                    signingKey?.let {
                        ...
                        XmtpLogging.logger.debug("XMTP", "No signer provided. Logging DB context...")
                        XmtpLogging.logger.debug("XMTP", "dbPath: $dbPath")

                        XmtpLogging.logger.debug("XMTP", "dbDirectory: ${clientOptions.dbDirectory}")

                        val dbDirFile = File(clientOptions.dbDirectory)
                        val fileCount = dbDirFile.listFiles()?.size ?: 0

                        XmtpLogging.logger.debug("XMTP", "Files in dbDirectory: $fileCount")
        ...
        private suspend fun createFfiClient(
            ...
            withContext(Dispatchers.IO) {
                ...
                val directoryFile = File(options.dbDirectory)
