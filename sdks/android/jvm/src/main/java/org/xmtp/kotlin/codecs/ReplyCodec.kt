...
import org.xmtp.kotlin.Client
import org.xmtp.kotlin.XMTPException

val ContentTypeReply =
...
data class ReplyCodec(
    override var contentType: ContentTypeId = ContentTypeReply,
) : ContentCodec<Reply> {
    ...
    override fun decode(content: EncodedContent): Reply {
        ...
        val replyContent =
            replyCodec.decode(content = replyEncodedContent)
    ...
    override fun fallback(content: Reply): String = "Replied with “${content.content}” to an earlier message"
