...
import org.xmtp.kotlin.codecs.EncodedContent
import org.xmtp.kotlin.codecs.compress
import org.xmtp.kotlin.libxmtp.ConversationDebugInfo
import org.xmtp.kotlin.libxmtp.ConversationDebugInfo.CommitLogForkStatus
import org.xmtp.kotlin.libxmtp.DecodedMessage
import org.xmtp.kotlin.libxmtp.DecodedMessage.MessageDeliveryStatus
import org.xmtp.kotlin.libxmtp.DecodedMessage.SortBy
import org.xmtp.kotlin.libxmtp.DecodedMessage.SortDirection
import org.xmtp.kotlin.libxmtp.DecodedMessageV2
import org.xmtp.kotlin.libxmtp.DisappearingMessageSettings
import org.xmtp.kotlin.libxmtp.GroupMembershipResult
import org.xmtp.kotlin.libxmtp.GroupMembershipState
import org.xmtp.kotlin.libxmtp.Member
import org.xmtp.kotlin.libxmtp.PermissionOption
import org.xmtp.kotlin.libxmtp.PermissionPolicySet
import org.xmtp.kotlin.libxmtp.PublicIdentity
            ...
            val messageCallback =
                object : FfiMessageCallback {
                    ...
                    override fun onError(error: FfiException) {
                        XmtpLogging.logger.error("XMTP Group stream", "Stream error: $error")
                    }
