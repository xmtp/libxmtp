...
import org.xmtp.kotlin.XmtpLogging
import org.xmtp.kotlin.codecs.Attachment
import org.xmtp.kotlin.codecs.ContentTypeId
import org.xmtp.kotlin.codecs.ContentTypeIdBuilder
import org.xmtp.kotlin.codecs.DeletedBy
import org.xmtp.kotlin.codecs.DeletedMessage
import org.xmtp.kotlin.codecs.LeaveRequest
import org.xmtp.kotlin.codecs.MultiRemoteAttachment
import org.xmtp.kotlin.codecs.Reaction
import org.xmtp.kotlin.codecs.ReactionAction
import org.xmtp.kotlin.codecs.ReactionSchema
import org.xmtp.kotlin.codecs.ReadReceipt
import org.xmtp.kotlin.codecs.RemoteAttachment
import org.xmtp.kotlin.codecs.RemoteAttachmentInfo
import org.xmtp.kotlin.codecs.TransactionReference
import org.xmtp.kotlin.codecs.decoded
import org.xmtp.kotlin.codecs.encodedContentFromFfi
...
class DecodedMessageV2 private constructor(
    ...
    val expiresAtNs: Long?
        get() = libXMTPMessage.expiresAtNs()
    ...
    fun <T> content(): T? =
        try {
            ...
            XmtpLogging.logger.error("DecodedMessageV2", "Error decoding content: ${e.message}")
            null
        }
    ...
    companion object {
        fun create(libXMTPMessage: FfiDecodedMessage): DecodedMessageV2? =
            try {
                ...
                XmtpLogging.logger.error("DecodedMessageV2", "Error creating DecodedMessageV2: ${e.message}")
                null
            }
