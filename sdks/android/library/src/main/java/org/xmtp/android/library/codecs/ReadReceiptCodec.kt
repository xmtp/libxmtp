...
data class ReadReceiptCodec(
    override var contentType: ContentTypeId = ContentTypeReadReceipt,
    ...
    override fun decode(content: EncodedContent): ReadReceipt = ReadReceipt

    override fun fallback(content: ReadReceipt): String? = null
