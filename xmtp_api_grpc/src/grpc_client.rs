...
impl Client for GrpcClient {
    ...
    async fn request(
        ...
        self.inner.ready().await.unwrap();

        // TODO: set any default headers
        let request = request.body(body).unwrap();
        // we can avoid the clone by using into_parts and from_parts on http/tonic request types
        // clone here for PoC purposes
    ...
    async fn stream(
        ...
        /* same as unary but call server_streaming instead */
        todo!()
    }
}
