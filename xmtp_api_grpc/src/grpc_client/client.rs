...
impl GrpcClient {
    ...
    fn build_tonic_request(
        ...
        body: Bytes,
    ) -> Result<tonic::Request<Bytes>, ApiClientError<GrpcError>> {
    ...
    async fn wait_for_ready(&self) -> Result<(), ApiClientError<GrpcError>> {
...
impl Default for ClientBuilder {
    fn default() -> Self {
        ClientBuilder {
            ...
            libxmtp_version: Default::default(),
            tls_channel: Default::default(),
