...
5. **Prose.** Every section's prose says why the mechanism exists, in the protocol's own terms and without metaphor (SPEC-010). Design history appears only where the mechanism departs from a standard, and there it names the standard behaviour (SPEC-091).
