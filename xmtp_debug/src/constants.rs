...
pub static XMTP_PRODUCTION_D14N: LazyLock<Url> = LazyLock::new(|| Url::parse("https://grpc.testnet.xmtp.network:443").unwrap());
...
pub static XMTP_PRODUCTION_PAYER: LazyLock<Url> = LazyLock::new(|| Url::parse("https://payer.testnet.xmtp.network:443").unwrap());
