...
impl Test {
    ...
    async fn message_visibility_test(&self) -> Result<()> {
        ...
        for i in 0..iterations {
            ...
            record_phase_metric("test_message_visibility_seconds", latency as f64 / 1000.0, "message_visibility", "xdbg_test");
    ...
    async fn group_sync_test(&self) -> Result<()> {
        ...
        for i in 0..iterations {
            ...
            latencies.push(latency);
            record_phase_metric("test_group_sync_seconds", latency as f64 / 1000.0, "group_sync", "xdbg_test");
